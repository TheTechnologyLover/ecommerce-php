                                    ...
                                    <div class="nk-block">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="productWeight" required name="productWeight">
                                            </div>
                                            <div class="form-group">
                                                <label for="deptName">Price</label>
                                                <input type="number" class="form-control" id="productPrice" required name="productPrice">
                                            </div>
                                            <div class="form-group">
