<?php
    ...
    if(isset($_GET['id'])){
        ...
        $orders = Crud::read("select order_items.productid, order_items.title, order_items.weight, order_items.price, quantity from order_items, products where order_items.productid = products.id and order_items.orderid = " . $id);
        if(sizeof($result) === 0){
